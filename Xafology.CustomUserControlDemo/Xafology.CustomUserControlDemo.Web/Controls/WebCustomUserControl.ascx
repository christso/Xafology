<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WebCustomUserControl.ascx.cs" Inherits="Xafology.CustomUserControlDemo.Web.Controls.WebCustomUserControl" %>
