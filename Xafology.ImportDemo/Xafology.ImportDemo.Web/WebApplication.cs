...
namespace Xafology.ImportDemo.Web
{
    ...
    public partial class ImportDemoAspNetApplication : WebApplication
    {
        ...
        private void ImportDemoAspNetApplication_DatabaseVersionMismatch(object sender, DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs e)
        {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
